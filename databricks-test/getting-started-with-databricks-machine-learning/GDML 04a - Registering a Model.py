...
# MAGIC <h3>Use the Model Registry to manage the model lifecycle.</h3>
...
experiment_name = f"/Users/{DA.username}/databricks_automl/retail-prediction-experiment"
model_name = "retail-prediction-best-model"
